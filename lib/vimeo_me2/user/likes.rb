module VimeoMe2
  module UserMethods
    module Likes
      ...
      def view_all_likes
        check_authorization
        make_http_request('get', request_uri("/likes") )
      end
      ...
      def check_if_liked video_id
        check_authorization
        make_http_request('get', request_uri("/likes/#{video_id}") )
      end
      ...
      def like_video video_id
        ...
        make_http_request('put', request_uri("/likes/#{video_id}") )
      end
      ...
      def unlinke_video video_id
        check_authorization('interact')
        make_http_request('delete', request_uri("/likes/#{video_id}") )
      end
    end
  end
end
