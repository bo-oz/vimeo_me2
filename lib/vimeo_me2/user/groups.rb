  ...
  module UserMethods
    module Groups
      ...
      def view_all_groups
        ...
        @client.make_http_request('get', request_uri("/groups") )
      end
      ...
      def check_if_user_joined_group group_id
        @client.check_authorization
        @client.make_http_request('get', request_uri("/groups/#{group_id}") )
      end
      ...
      def subscribe_to_channel group_id
        ...
        @client.make_http_request('put', request_uri("/groups/#{group_id}") )
      end
      ...
      def unsubscribe_from_channel group_id
        @client.check_authorization('interact')
        @client.make_http_request('delete', request_uri("/groups/#{group_id}") )
      end
    end
  end
end
